...
public class Steps extends BaseUtil {
    ...
    @Before()
    public void setup() {
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\MSI\\IdeaProjects\\cucumber_course\\resources\\chromedriver.exe");
...
//        assertTrue(actualuserFullName.contains(baseUtil.userFullName), actualuserFullName + " Incorrect");
